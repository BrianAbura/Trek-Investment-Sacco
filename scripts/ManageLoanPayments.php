...
if ($lnPaymentAction == "ADD") {
    ...
    //Distribute this payment against the loan's guarantors
    RecalculateGuarantorAmounts($Loan['LoanId']);
    ...
    //Redistribute payments against the loan's guarantors after an edit
    RecalculateGuarantorAmounts($loanPayment['LoanId']);
    ...
    if ($NewLoanBalance <= 0) {
        ...
        DB::update('guarantors', array('LoanStatus' => 'CLEARED'), 'LoanId=%s', $loanPayment['LoanId']);
