...
//Redistribute any payments if a guarantor's status changes
$guarantor = DB::queryFirstRow('SELECT LoanId from guarantors where Id=%s', $GuarantorId);
if ($guarantor) {
    RecalculateGuarantorAmounts($guarantor['LoanId']);
}
